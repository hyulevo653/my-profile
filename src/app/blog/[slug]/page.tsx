    ...
    {AppConfig.giscus.enabled && (
      <>
        ...
        <Script
          ...
          data-repo={AppConfig.giscus.repo}
          data-repo-id={AppConfig.giscus.repoId}
          data-category={AppConfig.giscus.category}
          data-category-id={AppConfig.giscus.categoryId}
